   ...
   ;  Version 25 - Fixed paddle tracking with coordinate adjustments
   ;  Paddles now remember last direction and pivot point adjusted
   ;***************************************************************
...
__BP1_NE
   ballx = player0x + 12 : bally = player0y - 10 : return
__BP1_E
   ballx = player0x + 14 : bally = player0y - 4 : return
__BP1_SE
   ballx = player0x + 12 : bally = player0y + 2 : return
__BP1_S
...
__BP2_NE
   ballx = player1x + 12 : bally = player1y - 10 : return
__BP2_E
   ballx = player1x + 14 : bally = player1y - 4 : return
__BP2_SE
   ballx = player1x + 12 : bally = player1y + 2 : return
__BP2_S
...
__BP2_NW
   ...
   ;  Coordinates adjusted: +4 X, -4 Y for proper pivot point
   ;***************************************************************
__Update_P1_Paddle
...
__MP1_NE
   missile0x = player0x + 12 : missile0y = player0y - 10 : goto __MP1_Done
__MP1_E
   missile0x = player0x + 14 : missile0y = player0y - 4 : goto __MP1_Done
__MP1_SE
   missile0x = player0x + 12 : missile0y = player0y + 2 : goto __MP1_Done
__MP1_S
...
__MP2_NE
   missile1x = player1x + 12 : missile1y = player1y - 10 : goto __MP2_Done
__MP2_E
   missile1x = player1x + 14 : missile1y = player1y - 4 : goto __MP2_Done
__MP2_SE
   missile1x = player1x + 12 : missile1y = player1y + 2 : goto __MP2_Done
__MP2_S
