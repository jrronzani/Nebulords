   ...
   dim ball_xvel = q
   dim ball_yvel = r
   dim ball_state = s         ; bit 0=attached to p1, bit 1=attached to p2, bit 2=high speed
...
__Ball_Follow_P2
   ...
   ;***************************************************************
   ;  Get offset position for direction (returns temp2=x, temp3=y)
   ;  Radius reduced to 11 pixels, shifted right by +3
   ;***************************************************************
...
__OP0  ; North
   temp2 = 3 : temp3 = 237 : return  ; -11 in Y + 3 X shift
__OP1  ; NNE
   temp2 = 7 : temp3 = 239 : return
__OP2  ; NE
   temp2 = 11 : temp3 = 241 : return
__OP3  ; ENE
   temp2 = 14 : temp3 = 244 : return
__OP4  ; East
   temp2 = 14 : temp3 = 0 : return  ; 11 pixels + 3 shift
__OP5  ; ESE
   temp2 = 14 : temp3 = 5 : return
__OP6  ; SE
   temp2 = 11 : temp3 = 8 : return
__OP7  ; SSE
   temp2 = 7 : temp3 = 10 : return
__OP8  ; South
   temp2 = 3 : temp3 = 11 : return
__OP9  ; SSW
   temp2 = 255 : temp3 = 10 : return  ; -1 in X + 3 = +2, so 255 + 3 works out
__OP10 ; SW
   temp2 = 251 : temp3 = 8 : return  ; -8 + 3 = -5
__OP11 ; WSW
   temp2 = 248 : temp3 = 5 : return  ; -11 + 3 = -8
__OP12 ; West
   temp2 = 248 : temp3 = 0 : return  ; -11 + 3 = -8
__OP13 ; WNW
   temp2 = 248 : temp3 = 244 : return
__OP14 ; NW
   temp2 = 251 : temp3 = 241 : return
__OP15 ; NNW
   temp2 = 255 : temp3 = 239 : return
...
__Check_Paddle_Collisions
   ...
   if collision(ball,missile0) then gosub __Ball_Hit_P1_Paddle
   
   ; Check P2 paddle (missile1)
   if collision(ball,missile1) then gosub __Ball_Hit_P2_Paddle
   return
