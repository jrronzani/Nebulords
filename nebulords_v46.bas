   ...
   ;  Version 46 - Adjust catch positions for wider side paddles
   ;  Based on v45 (preserve launch timer)
   ;
   ;  Caught ball positions extended by 2 pixels on East/West to match paddle
   ;
