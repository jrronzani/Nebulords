  ;***************************************************************
  ;  NEBULORDS PXE - Version 009
  ;  Warlords-style Space Combat with Paddle Controls
  ;
  ;  Changes from v008:
  ;  - Added back rainbow playfield colors (176-line pfcolors array)
  ;  - Testing if pfcolors was what broke paddle control in v004-v007
  ;    or if it was the button movement code
  ;
  ;  Same as v008 otherwise (automatic movement, PXE colors, ball)
  ;
  ;  Controls:
