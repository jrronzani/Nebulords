   ;***************************************************************
   ;  PFSCORE TEST V5 - UI Layout for Nebulords
   ;
   ;  SCREEN LAYOUT (Top to Bottom):
   ;  1. SCORE at top: [Level:01-10][P1:00-99][P2:00-99]
   ;  2. HEALTH BARS (pfscore): |||||||| P1  P2 ||||||||
   ;  3. PLAYFIELD (arena)
   ;
   ;  FIXED: Reduced playfield size so score is visible!
   ;
   ;  Features:
   ;  - 6-digit score at very top
   ;  - Health bars just below score
...
__Init
   ...
   ;***************************************************************
   ;  Playfield - SMALLER arena so score shows at top
   ;***************************************************************
   playfield:
   ................................
   ................................
