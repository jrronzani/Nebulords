  ;***************************************************************
  ;  NEBULORDS PXE - BOTS Version 018
  ;  Warlords-style Space Combat with Paddle Controls
  ;  Supports 1P vs Bot and 2P vs 2P modes via Game Select switch
  ;
  ;  Based on: bots_v017
  ;
  ;  Changes from bots_v017:
  ;  - FIX: Scoring bug - changed threshold from Y<100 to Y<150 (playfield bottom)
  ;  - FIX: Renamed invincibility_timer → round_reset_timer (more accurate name)
  ;
  ...
  ;***************************************************************
  const round_reset_duration = 180 ; 3 seconds at 60fps (countdown after death)
...
__P1_Core_Hit
  ...
  round_reset_timer = round_reset_duration
  return
