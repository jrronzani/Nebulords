  ;***************************************************************
  ;  NEBULORDS PXE - BOTS Version 020
  ...
  ;  - FIX: Paddle wall boundaries prevent ball sprite wrapping
  ;  - ADD: Shared __Paddle_Walls function (4 lines, consolidated)
  ;  - Paddles constrained to X:11-129, Y:26-117 (prevents ball wrap)
  ;
...
__Update_P2_Paddle
  ...
  ;  Constrains paddles so attached ball stays in bounds (4-155, 8-157)
  ;***************************************************************
__Paddle_Walls
  if player2x < 11 then player2x = 11
  if player2x > 129 then player2x = 129
  if player2y < 26 then player2y = 26
  if player2y > 117 then player2y = 117
  if player3x < 11 then player3x = 11
  if player3x > 129 then player3x = 129
  if player3y < 26 then player3y = 26
  if player3y > 117 then player3y = 117
  return
