  ;***************************************************************
  ;  NEBULORDS PXE - BOTS Version 008
  ;  Warlords-style Space Combat with Paddle Controls
  ;  4-PLAYER MODE: 1 Human vs 3 AI Bots
  ;
  ;  Based on: bots_v007 (Fix P3/P4 AI and game logic)
  ;
  ;  Changes from bots_v007:
  ;  - FIX: P3/P4 starting positions (move up 30 pixels)
  ;  - FIX: Add paddle update functions for P3/P4 (player6/player7)
  ;  - FIX: Winning condition - only award points when round ends
  ;  - FIX: P3/P4 sprite updates after brick hits
  ;  - FIX: P3/P4 AI not running
  ;  - FIX: Player-to-player collision for P3/P4
  ;  - FIX: Round reset to not respawn dead players
  ;***************************************************************
