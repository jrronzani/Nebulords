  ...
  ;  - FIX: Widened walls slightly for better playability
  ;  - Ship boundaries: X:6-136 (was 7-135), Y:12-131 (was 14-129)
  ;  - 1 pixel wider on sides, 2 pixels wider top/bottom
  ;
...
__Wall_Bounce
  ...
  ; Check left wall
  if temp_player_num = 0 then if player0x < 6 then temp_dir_x = 1 : player0x = 6 : temp_frame_x = temp_speed_x
  if temp_player_num = 1 then if player1x < 6 then temp_dir_x = 1 : player1x = 6 : temp_frame_x = temp_speed_x

  ; Check right wall
  if temp_player_num = 0 then if player0x > 136 then temp_dir_x = 255 : player0x = 136 : temp_frame_x = temp_speed_x
  if temp_player_num = 1 then if player1x > 136 then temp_dir_x = 255 : player1x = 136 : temp_frame_x = temp_speed_x

  ; Check top wall
  if temp_player_num = 0 then if player0y < 12 then temp_dir_y = 1 : player0y = 12 : temp_frame_y = temp_speed_y
  if temp_player_num = 1 then if player1y < 12 then temp_dir_y = 1 : player1y = 12 : temp_frame_y = temp_speed_y

  ; Check bottom wall
  if temp_player_num = 0 then if player0y > 131 then temp_dir_y = 255 : player0y = 131 : temp_frame_y = temp_speed_y
  if temp_player_num = 1 then if player1y > 131 then temp_dir_y = 255 : player1y = 131 : temp_frame_y = temp_speed_y
