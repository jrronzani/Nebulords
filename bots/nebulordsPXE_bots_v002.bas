  ;***************************************************************
  ;  NEBULORDS PXE - BOTS Version 002
  ;  Warlords-style Space Combat with Paddle Controls
  ;  EXPERIMENTAL: 1v1 AI Bot Mode (P1 Human vs P2 AI)
  ;
  ;  Based on: bots_v001 (HARD difficulty upgrade)
  ;
  ;  Changes from bots_v001:
  ;  - IMPROVE: Faster reaction time (30 frames = 0.5 seconds, was 60)
  ;  - IMPROVE: Better aim accuracy (±1 noise, was ±2)
  ;  - IMPROVE: Less wandering (5% chance, was 20%)
  ;  - IMPROVE: More aggressive thrust (25%/30% chances, was 12%/18%)
  ;  - IMPROVE: Better catch rate (50%, was 30%)
  ;  - FIX: Direction mapping corrected for accurate ball tracking
  ;  - DIFFICULTY: Hard bot (v001 was Easy)
  ;
  ;  AI Behavior (HARD):
  ...
  ;  - Thrust: 25% when far, 30% when close (aggressive)
