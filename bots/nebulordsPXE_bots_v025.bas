  ...
  ;***************************************************************
  ;  DEATH ANIMATION VARIABLE
  ;***************************************************************
  dim death_anim_counter = var17  ; 0=inactive, 1-48=active (16 frames * 3 ticks)
  ; REPLACED - SEE BELOW
  ; REPLACED - SEE BELOW
  ; REPLACED - SEE BELOW
  ; REPLACED - SEE BELOW
...
__Game_Init
  ...
  death_anim_counter = 0     ; No animation at start
...
__Skip_Ball_Physics
  ...
  ;***************************************************************
  if death_anim_counter > 0 then gosub __Advance_Death_Animation
...
__Advance_Death_Animation
  ; Increment counter (1-48 for 16 frames * 3 ticks each)
