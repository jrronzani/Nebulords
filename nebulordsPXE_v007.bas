  ;***************************************************************
  ;  NEBULORDS PXE - Version 007
  ;  Warlords-style Space Combat with Paddle Controls
  ;
  ;  Changes from v006:
  ;  - Fixed PXE color system (use player0color:/player1color: labels)
  ;  - Reverted to player0/player1 sprites
  ;  - Kept minimal pfcolors fix (THE KEY FIX!)
  ;
  ;  Controls:
...
__Game_Init
  ...
  ;***************************************************************
  ;  Define ship sprites (13 pixels tall)
  ;***************************************************************
  player0:
  %00111100
  %00111100
  ...
  ; PXE color definition for player0 (one color per scanline)
  player0color:
  $AC
  $AC
  $AC
  ...
  ; PXE color definition for player1 (one color per scanline)
  player1color:
  $46
  $46
  $46
...
__BV_15
  ...
  ;***************************************************************
  ;  Setup Playfield with minimal pfcolors (THE FIX!)
  ;***************************************************************
__Setup_Playfield
  playfield:
  ...
  ; Minimal pfcolors (like 17 sprites example) - THE KEY FIX!
  pfcolors:
  $0E
  $0E
end
