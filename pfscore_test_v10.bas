   ;***************************************************************
   ;  PFSCORE TEST V10 - Zero-G Physics with Deceleration
   ;
...
__Accel_Right
   ...
   if dir_x = 1 then if speed_x > 1 then speed_x = speed_x - 1
   return
...
__Accel_Left
   ...
   if dir_x = 255 then if speed_x > 1 then speed_x = speed_x - 1
   return
...
__Accel_Up
   ...
   if dir_y = 255 then if speed_y > 1 then speed_y = speed_y - 1
   return
...
__Accel_Down
   ...
   if dir_y = 1 then if speed_y > 1 then speed_y = speed_y - 1
   return
