   ...
   ;  Version 38 - Save/restore collision using temp variables
   ;  Independent X/Y movement with position memory for wall-sliding
   ;
...
__Skip_P1_Controls
   ...
   ;***************************************************************
   ;  Handle Player 2 controls - Save/restore independent X/Y
   ;***************************************************************
   ...
   if collision(player1, playfield) then player1x = temp2
   ...
   if collision(player1, playfield) then player1y = temp2
