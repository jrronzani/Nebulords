  ;***************************************************************
  ;  NEBULORDS PXE - Version 008
  ;  Warlords-style Space Combat with Paddle Controls
  ;
  ;  Changes from v007:
  ;  - Removed button-activated movement (back to v003 auto-movement)
  ;  - Ships now move constantly in paddle direction (like v003)
  ;  - Kept v007 PXE color system (player0color/player1color)
  ;  - Kept v005 thicker playfield borders (3 rows top/bottom)
  ;  - Kept ball physics
  ;
  ;  Controls:
  ;  - Paddle 0/1: Direction (16 positions, ships move automatically)
  ;***************************************************************
...
__Main_Loop
  ...
  ;***************************************************************
  ;  Apply movement automatically (like v003)
  ;***************************************************************
