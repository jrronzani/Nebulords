  ...
  ;  Version 23 - Playfield scores and fixed paddle positioning
  ;***************************************************************

  set romsize 8k
  set kernel_options pfscores
...
__Game_Init
  ...
  ;***************************************************************
  ;  Define playfield border (top 1 row blank for score display)
  ;***************************************************************
  playfield:
  ................................
...
__P1_Destroyed
  ...
  ; P2 wins - increment pfscore2 (right side)
  pfscore2 = pfscore2 + 1
...
__P2_Destroyed
  ...
  ball_state = 0  ; Release ball if attached
  ; P1 wins - increment pfscore1 (left side)
  pfscore1 = pfscore1 + 1
  game_state = 2  ; Victory state
  death_timer = 180  ; 3 second countdown
  return
...
__BP2_NW
  ...
  ;***************************************************************
  ;  Update paddle positions - 8 discrete positions using on goto
  ;  Adjusted: +4 right, -4 up, +1 radius
  ;***************************************************************
__Update_P1_Paddle
  temp1 = p1_direction
