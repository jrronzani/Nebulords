   ...
   ;  Version 35 - Independent X/Y collision (from v34, not v33's pfread)
   ;  v33's pfread() was too complex and had coordinate bugs
   ;  This simple approach: move, check collision, undo if hit
   ;***************************************************************
...
__Main_Loop
   ...
   ;***************************************************************
   ;  Handle Player 1 controls - X and Y independently
   ;***************************************************************
   ; Only process if alive
   if !p1_alive then goto __Skip_P1_Controls

   ; X axis: Read input, apply movement, check collision, stop if hit
   p1_xspeed = 0
   ...
   ; Y axis: Read input, apply movement, check collision, stop if hit
   p1_yspeed = 0
...
__Skip_P1_Controls
   ...
   ;***************************************************************
   ;  Handle Player 2 controls - X and Y independently
   ;***************************************************************
