   ...
   ;  Version 54 - Fix shield bug + add 16 sprite frames
   ;  Based on v53 (shield system)
   ;
   ;  P2 starting position set to 108 for visual symmetry
   ;  Ball respawns at top center if out of bounds for 1 second
   ;  Shield invulnerability removed (was causing issues)
   ;  Added all 16 sprite frames for shield visualization
   ;
...
__P1_Shield_Bounce
   ; Shield broken - bounce ball away
