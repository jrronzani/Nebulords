  ;***************************************************************
  ;  NEBULORDS PXE - Version 004
  ;  Warlords-style Space Combat with Paddle Controls
  ;
  ;  Changes from v003:
  ;  - Added ball with simple physics (constant velocity)
  ;  - Movement now button-activated (hold paddle button to move)
  ;  - Added rainbow playfield colors (cycling gradient)
  ;  - Updated player colors: P1=cyan, P2=purple
  ;
  ;  Controls:
  ...
  ; Ball
  dim ball_xvel = k              ; Ball X velocity
  dim ball_yvel = l              ; Ball Y velocity

  ; Temp variables
  dim temp_paddle = m            ; Temp for paddle reading
  dim temp_dir = n               ; Temp for direction calculation
...
__Game_Init
  ...
  COLUP0 = $B6                   ; Cyan for Player 1
  COLUP1 = $64                   ; Purple for Player 2
