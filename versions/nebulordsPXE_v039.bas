  ;***************************************************************
  ;  NEBULORDS PXE - Version 039
  ;  Warlords-style Space Combat with Paddle Controls
  ;
  ;  Changes from v038:
  ;  - FIX: Deflect velocities normalized to slow speed (no more fast diagonal deflects)
  ;  - FIX: Player 2 paddle hitbox shifted +2px right (fixes ghost collision)
  ;
  ;  Changes from v037:
  ;  - FIX: Auto-launch now checks ball_state (prevents re-launch every frame)
...
__P2_Button_Done
  ...
  ; Check P2 paddle (player3) - hitbox shifted +2px right
  if ballx < player3x + 8 && ballx + 2 > player3x + 2 then if bally < player3y + 9 && bally + 4 > player3y then gosub __Check_P2_Paddle
...
__BB1_0  ; North (up) - slow speed
  ball_xvel = 0 : ball_yvel = 255 : return
__BB1_1  ; NNE - slow speed
  ball_xvel = 1 : ball_yvel = 255 : return
__BB1_2  ; NE - slow speed
  ball_xvel = 1 : ball_yvel = 255 : return
__BB1_3  ; ENE - slow speed
  ball_xvel = 1 : ball_yvel = 255 : return
__BB1_4  ; East (right) - slow speed
  ball_xvel = 1 : ball_yvel = 0 : return
__BB1_5  ; ESE - slow speed
  ball_xvel = 1 : ball_yvel = 1 : return
__BB1_6  ; SE - slow speed
  ball_xvel = 1 : ball_yvel = 1 : return
__BB1_7  ; SSE - slow speed
  ball_xvel = 1 : ball_yvel = 1 : return
__BB1_8  ; South (down) - slow speed
  ball_xvel = 0 : ball_yvel = 1 : return
__BB1_9  ; SSW - slow speed
  ball_xvel = 255 : ball_yvel = 1 : return
__BB1_10  ; SW - slow speed
  ball_xvel = 255 : ball_yvel = 1 : return
__BB1_11  ; WSW - slow speed
  ball_xvel = 255 : ball_yvel = 1 : return
__BB1_12  ; West (left) - slow speed
  ball_xvel = 255 : ball_yvel = 0 : return
__BB1_13  ; WNW - slow speed
  ball_xvel = 255 : ball_yvel = 255 : return
__BB1_14  ; NW - slow speed
  ball_xvel = 255 : ball_yvel = 255 : return
__BB1_15  ; NNW - slow speed
  ball_xvel = 255 : ball_yvel = 255 : return
...
__BB2_0  ; North (up) - slow speed
  ball_xvel = 0 : ball_yvel = 255 : return
__BB2_1  ; NNE - slow speed
  ball_xvel = 1 : ball_yvel = 255 : return
__BB2_2  ; NE - slow speed
  ball_xvel = 1 : ball_yvel = 255 : return
__BB2_3  ; ENE - slow speed
  ball_xvel = 1 : ball_yvel = 255 : return
__BB2_4  ; East (right) - slow speed
  ball_xvel = 1 : ball_yvel = 0 : return
__BB2_5  ; ESE - slow speed
  ball_xvel = 1 : ball_yvel = 1 : return
__BB2_6  ; SE - slow speed
  ball_xvel = 1 : ball_yvel = 1 : return
__BB2_7  ; SSE - slow speed
  ball_xvel = 1 : ball_yvel = 1 : return
__BB2_8  ; South (down) - slow speed
  ball_xvel = 0 : ball_yvel = 1 : return
__BB2_9  ; SSW - slow speed
  ball_xvel = 255 : ball_yvel = 1 : return
__BB2_10  ; SW - slow speed
  ball_xvel = 255 : ball_yvel = 1 : return
__BB2_11  ; WSW - slow speed
  ball_xvel = 255 : ball_yvel = 1 : return
__BB2_12  ; West (left) - slow speed
  ball_xvel = 255 : ball_yvel = 0 : return
__BB2_13  ; WNW - slow speed
  ball_xvel = 255 : ball_yvel = 255 : return
__BB2_14  ; NW - slow speed
  ball_xvel = 255 : ball_yvel = 255 : return
__BB2_15  ; NNW - slow speed
  ball_xvel = 255 : ball_yvel = 255 : return
