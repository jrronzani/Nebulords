  ;***************************************************************
  ;  NEBULORDS PXE - Version 030
  ;  Warlords-style Space Combat with Paddle Controls
  ;
  ;  Changes from v029:
  ;  - CATCHING/LAUNCHING MECHANICS: Ball can be caught and launched
  ;  - Slower default ball speed (1 px/frame). Launch speed = 2 px/frame (current v029 speed)
  ;  - Hold button when ball hits paddle to catch it
  ;  - Caught ball sticks to paddle and rotates around ship
  ;  - Release button to launch in paddle's facing direction
  ;  - Fast mode: 4 seconds (240 frames) at launch speed after release
  ;  - Auto-launch: Ball launches automatically after 3 seconds (180 frames) if held
  ;  - Catch cooldown: 4 seconds (240 frames) after auto-launch before can catch again
  ;
  ;  Physics System:
