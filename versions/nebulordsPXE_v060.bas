  ;***************************************************************
  ;  NEBULORDS PXE - Version 060
  ;  Warlords-style Space Combat with Paddle Controls
  ;
  ;  Changes from v059:
  ;  - FIX: Ships can now stop moving by thrusting opposite direction
  ;  - Each axis (X/Y) stops independently - maintains drift on other axis
  ;  - Added return after deceleration stops to prevent same-frame re-accel
  ;
  ;  Changes from v048:
