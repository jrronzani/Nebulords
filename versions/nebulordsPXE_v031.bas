  ;***************************************************************
  ;  NEBULORDS PXE - Version 031
  ;  Warlords-style Space Combat with Paddle Controls
  ;
  ;  Changes from v030:
  ;  - BRICK/SHIELD SPRITES: Redesigned ship with 4 destroyable bricks
  ;  - Top, Left, Right, Bottom bricks surround a central core
  ;  - Each brick is 5-6 scanlines, clearly visible and distinct
  ;  - Core is %00011000 pattern (small target in center)
  ;  - When brick destroyed, that section goes blank, exposing core
  ;  - Next version will add brick hitbox detection
  ;
  ;  Physics System:
...
__Game_Init
  ...
  ;***************************************************************
  ;  Define ship sprites - 26 scanlines with 4 destroyable bricks
  ;  Layout: Top brick (1-5), connectors (6-7), Left/Right bricks + core (8-14)
  ;          connectors (15-16), Bottom brick (17-21), taper (22-26)
  ;***************************************************************
  player0:
  %11111111    ; Line 1  - TOP BRICK
  %11111111    ; Line 2  - TOP BRICK
  %11111111    ; Line 3  - TOP BRICK
  %11111111    ; Line 4  - TOP BRICK
  %11111111    ; Line 5  - TOP BRICK
  %11111111    ; Line 6  - TOP BRICK (transition)
  %11000011    ; Line 7  - Connector (exposes core when top destroyed)
  %11000011    ; Line 8  - Connector
  %11011011    ; Line 9  - LEFT BRICK + CORE + RIGHT BRICK
  %11011011    ; Line 10 - LEFT BRICK + CORE + RIGHT BRICK
  %11011011    ; Line 11 - LEFT BRICK + CORE + RIGHT BRICK (middle)
  %11011011    ; Line 12 - LEFT BRICK + CORE + RIGHT BRICK
  %11011011    ; Line 13 - LEFT BRICK + CORE + RIGHT BRICK
  %11011011    ; Line 14 - LEFT BRICK + CORE + RIGHT BRICK
  %11000011    ; Line 15 - Connector
  %11000011    ; Line 16 - Connector (exposes core when bottom destroyed)
  %11111111    ; Line 17 - BOTTOM BRICK
  %11111111    ; Line 18 - BOTTOM BRICK
  %11111111    ; Line 19 - BOTTOM BRICK
  %11111111    ; Line 20 - BOTTOM BRICK
  %11111111    ; Line 21 - BOTTOM BRICK
  %00111100    ; Line 22 - Taper
  %00111100    ; Line 23 - Taper
  %00111100    ; Line 24 - Taper
  %00111100    ; Line 25 - Taper
  %00111100    ; Line 26 - Taper
end
