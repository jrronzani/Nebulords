  ;***************************************************************
  ;  NEBULORDS PXE - Version 061
  ;  Warlords-style Space Combat with Paddle Controls
  ;
  ;  Changes from v060:
  ;  - FIX: Check brick collision BEFORE ball moves (prevents pass-through)
  ;  - FIX: Removed brick immunity system (was causing ball to pass through)
  ;
  ;  Changes from v048:
...
__P2_Button_Done
  ...
  ;***************************************************************
  ;  Ball/Ship Collision Detection - Brick breaking (CHECK BEFORE MOVE!)
  ;  Using coordinate-based AABB collision
  ...
  if player0y < 100 then if ballx < player0x + 16 && ballx + 2 > player0x then if bally < player0y + 26 && bally + 4 > player0y then gosub __P1_Brick_Hit : goto __Skip_Brick_Collision
...
__Skip_Brick_Collision
  ...
  ; Ball is free - move ball AFTER collision check
