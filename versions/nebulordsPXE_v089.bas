  ;***************************************************************
  ;  NEBULORDS PXE - Version 089
  ;  Warlords-style Space Combat with Paddle Controls
  ;
  ;  Changes from v079B:
  ;  - OPTIMIZE: Compress paddle code using data tables (CORRECT format with _underscore)
  ;  - ADD: _paddle_x_offsets and _paddle_y_offsets lookup tables
  ;  - REDUCE: Remove redundant sprite definitions, use table lookups
  ;  - This should work with proper data table syntax
  ;
  ;  Changes from v077:
...
__Award_P2_Point
  ...
  ;  X and Y offsets for all 32 positions (relative to ship)
  ;***************************************************************
  ...
  ;***************************************************************
  ;  GLOBAL PADDLE SPRITES (used for all positions)
  ;***************************************************************
  player2:
    %011110
    %111111
  ...
  ;***************************************************************
__Update_P1_Paddle
  player2x = player0x + _paddle_x_offsets[temp_dir]
  player2y = player0y + _paddle_y_offsets[temp_dir]
  return

__Update_P2_Paddle
  player3x = player1x + _paddle_x_offsets[temp_dir]
  player3y = player1y + _paddle_y_offsets[temp_dir]
  return
