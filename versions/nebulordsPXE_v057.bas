...
__P1_Middle_Area
  ...
  if p1_bricks{2} = 0 then goto __P1_Core_Hit
  if p1_bricks{1} = 0 then goto __P1_Core_Hit
  return
...
__P2_Middle_Area
  ...
  ; Ball is in center X - check if core exposed (either side brick destroyed)
  if p2_bricks{2} = 0 then goto __P2_Core_Hit
  if p2_bricks{1} = 0 then goto __P2_Core_Hit
  return
