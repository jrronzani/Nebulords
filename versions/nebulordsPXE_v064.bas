...
__P2_Button_Done
  ...
  ;***************************************************************
  if invincibility_timer > 0 then goto __Skip_Brick_Collision

  ; P1 coordinate collision: exact sprite bounds (16x26) - using inclusive bounds
  if player0y < 100 then if (bally + 4) >= player0y && bally <= (player0y + 26) then if (ballx + 2) >= player0x && ballx <= (player0x + 16) then gosub __P1_Brick_Hit : goto __Skip_Brick_Collision
  ; P2 coordinate collision (shifted +2px for player1 sprite offset) - using inclusive bounds
  if player1y < 100 then if (bally + 4) >= player1y && bally <= (player1y + 26) then if (ballx + 2) >= (player1x + 2) && ballx <= (player1x + 18) then gosub __P2_Brick_Hit
...
__Skip_Ball_Physics
  ...
  ;***************************************************************
  ;  Post-Movement Brick Collision (catch pass-through)
  ;***************************************************************
  if invincibility_timer > 0 then goto __Skip_Post_Collision
  if player0y < 100 then if (bally + 4) >= player0y && bally <= (player0y + 26) then if (ballx + 2) >= player0x && ballx <= (player0x + 16) then gosub __P1_Brick_Hit : goto __Skip_Post_Collision
  if player1y < 100 then if (bally + 4) >= player1y && bally <= (player1y + 26) then if (ballx + 2) >= (player1x + 2) && ballx <= (player1x + 18) then gosub __P2_Brick_Hit
__Skip_Post_Collision
