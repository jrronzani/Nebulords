  ;***************************************************************
  ;  NEBULORDS PXE - Version 028
  ;  Warlords-style Space Combat with Paddle Controls
  ;
  ;  Changes from v027:
  ;  - VARIABLE OPTIMIZATION: Use system variables directly
  ;  - Eliminated player0x/ypos, player1x/ypos (4 vars saved!)
  ;  - Now use player0x/y, player1x/y directly throughout code
  ;  - Reduces from 9 to 7 variables per player
  ;  - Prepares for 4-player support (will need 28 vars instead of 36)
  ;
  ;  Physics System:
