...
__Player_Collision
  ...
  if p1_ypos >= p2_ypos + ship_height then goto __No_Collision
  if p1_ypos + ship_height <= p2_ypos then goto __No_Collision
...
__PC_Separate
  ...
  if p1_xpos < p2_xpos then p1_xpos = p1_xpos - 2 : p2_xpos = p2_xpos + 2
  if p1_xpos >= p2_xpos then p1_xpos = p1_xpos + 2 : p2_xpos = p2_xpos - 2
