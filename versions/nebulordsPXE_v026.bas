  ;***************************************************************
  ;  NEBULORDS PXE - Version 026
  ;  Warlords-style Space Combat with Paddle Controls
  ;
  ;  Changes from v025:
  ;  - REVERTED to v021's simpler thrust detection
  ;  - Removed first-press detection complexity
  ;  - Kept v025's step by 2 increments (16->14->12->10->8->6->4->2)
  ;  - Slowest speed: 16 frames (1 pixel every 16 frames)
  ;  - Thrust applies when button held and accel_counter = 0
  ;
  ;  Physics System:
