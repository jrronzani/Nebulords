  ;***************************************************************
  ;  NEBULORDS PXE - Version 022
  ;  Warlords-style Space Combat with Paddle Controls
  ;
  ;  Changes from v021:
  ;  - Finer speed granularity for micro-adjustments
  ;  - Speed range expanded: 2 (max) to 20 (stopped) - was 2 to 10
  ;  - 18 speed steps instead of 8 for smoother deceleration
  ;  - Easier to zero out unwanted drift with button taps
  ;  - Same accel_delay = 3 for consistent feel
  ;
  ;  Physics System:
  ;  - speed_x/y: Frames between pixel moves (lower = faster)
  ;  - max_speed = 2: Top speed (moves every 2 frames)
  ;  - Speed range: 2-20 (18 acceleration steps)
  ...
  ;  - Tapping: Make micro-adjustments to straighten trajectory
  ;
  ;  Technical details:
