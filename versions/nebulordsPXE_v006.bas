  ;***************************************************************
  ;  NEBULORDS PXE - Version 006
  ;  Warlords-style Space Combat with Paddle Controls
  ;
  ;  Changes from v005:
  ;  - REMOVED massive 176-line pfcolors array (was corrupting paddle reads)
  ;  - Using minimal pfcolors like 17 sprites example
  ;  - Switched to player2/player3 for ships (player0/1 reserved in PXE)
  ;  - Simple white playfield border
  ;
  ;  Controls:
  ...
  ;***************************************************************
  ; Player 1 (Paddle 0) - using player2 sprite
  dim p1_xpos = a
  dim p1_ypos = b
  ...
  ; Player 2 (Paddle 1) - using player3 sprite
  dim p2_xpos = f
  dim p2_ypos = g
...
__Game_Init
  ...
  COLUP2 = $AC                   ; Bright cyan for Player 1 (using player2)
  COLUP3 = $46                   ; Bright purple/magenta for Player 2 (using player3)
  ...
  ;  Using player2 and player3 instead of player0/player1
  ;***************************************************************
  player2:
  %00111100
  %00111100
...
__Main_Loop
  ...
  ;***************************************************************
  ;  Update sprite positions (using player2 and player3)
  ;***************************************************************
  player2x = p1_xpos
  player2y = p1_ypos
  player3x = p2_xpos
...
__BV_15  ; NNW
  ...
  ;  Simple white border, minimal pfcolors
  ;***************************************************************
__Setup_Playfield
  playfield:
  ...
  ; Minimal pfcolors (like 17 sprites example)
  pfcolors:
  $0E
  $0E
end
