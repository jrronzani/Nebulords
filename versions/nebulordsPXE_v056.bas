...
__P1_Brick_Hit
  ...
  ; Y determines top/middle/bottom section (expanded +1px each direction)
  if bally + 4 > player0y + 21 then goto __P1_Bottom_Area
  if bally + 4 > player0y + 5 then goto __P1_Middle_Area
  goto __P1_Top_Area
...
__P1_Middle_Area
  ; X determines left or right side (expanded +1px for left side)
  if ballx + 1 < player0x + 9 then goto __P1_Left_Area
...
__P2_Brick_Hit
  ...
  ; Y determines top/middle/bottom section (expanded +1px each direction)
  if bally + 4 > player1y + 21 then goto __P2_Bottom_Area
  if bally + 4 > player1y + 5 then goto __P2_Middle_Area
  goto __P2_Top_Area
...
__P2_Middle_Area
  ; X determines left or right side (shifted +2 for P2, expanded +1px)
  if ballx + 1 < player1x + 11 then goto __P2_Left_Area
