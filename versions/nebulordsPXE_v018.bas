  ;***************************************************************
  ;  NEBULORDS PXE - Version 018
  ;  Warlords-style Space Combat with Paddle Controls
  ;
  ;  Changes from v017:
  ;  - Simplified paddle sprites to single rounded bar sprite (all directions)
  ;  - Calculated 12 intermediate positions via linear interpolation
  ;  - Based on user's manual positioning of 4 cardinal directions:
  ;    - Direction 0 (South): X=+4, Y=+28
  ;    - Direction 4 (West): X=-8, Y=+8
  ;    - Direction 8 (North): X=+4, Y=-11
  ;    - Direction 12 (East): X=+16, Y=+8
  ;  - Applied same positioning to both Player 1 and Player 2
  ;
  ;  Technical details:
...
__P2P_8
  ...
  player3x = p2_xpos + 4 : player3y = p2_ypos - 11
  return
...
__P2P_12
  ...
  player3x = p2_xpos + 16 : player3y = p2_ypos + 8
  return
