...
__BF1_0  ; South - paddle at (+4, +28), adjusted offset (+6, +4)
  ballx = player0x + 10 : bally = player0y + 32 : return
__BF1_1  ; SSW - paddle at (-1, +24), adjusted offset (+3, +4)
  ballx = player0x + 2 : bally = player0y + 28 : return
__BF1_2  ; SW - paddle at (-5, +21), adjusted offset (0, +4)
  ballx = player0x - 5 : bally = player0y + 25 : return
__BF1_3  ; WSW - paddle at (-8, +15), adjusted offset (0, +2)
...
__BF1_13  ; ESE - paddle at (+16, +15), adjusted offset (+11, +2)
  ballx = player0x + 27 : bally = player0y + 17 : return
__BF1_14  ; SE - paddle at (+13, +21), adjusted offset (+10, +4)
  ballx = player0x + 23 : bally = player0y + 25 : return
__BF1_15  ; SSE - paddle at (+9, +24), adjusted offset (+8, +4)
  ballx = player0x + 17 : bally = player0y + 28 : return
...
__BF2_0  ; South - paddle at (+4, +28), adjusted offset (+6, +4)
  ballx = player1x + 10 : bally = player1y + 32 : return
__BF2_1  ; SSW - paddle at (-1, +24), adjusted offset (+3, +4)
  ballx = player1x + 2 : bally = player1y + 28 : return
__BF2_2  ; SW - paddle at (-5, +21), adjusted offset (0, +4)
  ballx = player1x - 5 : bally = player1y + 25 : return
__BF2_3  ; WSW - paddle at (-8, +15), adjusted offset (0, +2)
...
__BF2_13  ; ESE - paddle at (+16, +15), adjusted offset (+11, +2)
  ballx = player1x + 27 : bally = player1y + 17 : return
__BF2_14  ; SE - paddle at (+13, +21), adjusted offset (+10, +4)
  ballx = player1x + 23 : bally = player1y + 25 : return
__BF2_15  ; SSE - paddle at (+9, +24), adjusted offset (+8, +4)
  ballx = player1x + 17 : bally = player1y + 28 : return
