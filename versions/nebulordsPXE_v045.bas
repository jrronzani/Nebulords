  ;***************************************************************
  ;  NEBULORDS PXE - Version 045
  ;  Warlords-style Space Combat with Paddle Controls
  ;
  ;  Changes from v044:
  ;  - FIX: Left/right brick sprites now show correct graphics (removed core pixels)
...
__Skip_Paddle_Collision
  ...
  if player0y < 100 then if collision(ball,player0) then gosub __P1_Brick_Hit
...
__P1_Brick_Hit
  ...
  ; Bottom brick: Ball bottom in Y offset 19-25 (visual bottom of sprite)
  if bally + 4 > player0y + 19 then goto __P1_Bottom_Brick
  ; Middle section (left/right): Ball bottom in Y offset 9-18
  if bally + 4 > player0y + 9 then goto __P1_Middle_Brick
  ; Top brick: Ball bottom in Y offset 0-8 (visual top of sprite)
  goto __P1_Top_Brick
...
__P1_Middle_Brick
  ...
  ; Sprite is ~16 pixels wide: left brick (0-5), core (6-9), right brick (10-15)
  ; Left brick: ballx < player0x + 6
  if ballx < player0x + 6 then goto __P1_Left_Brick
  ; Core (center): ballx >= player0x + 6 && ballx < player0x + 10
  if ballx < player0x + 10 then goto __P1_Core_Hit
  ; Right brick: ballx >= player0x + 10
...
__P2_Brick_Hit
  ...
  ; Check BOTTOM of ball to determine which brick was hit
  ; Bottom brick: Ball bottom in Y offset 19-25 (visual bottom of sprite)
  if bally + 4 > player1y + 19 then goto __P2_Bottom_Brick
  ; Middle section (left/right): Ball bottom in Y offset 9-18
  if bally + 4 > player1y + 9 then goto __P2_Middle_Brick
  ; Top brick: Ball bottom in Y offset 0-8 (visual top of sprite)
  goto __P2_Top_Brick
...
__P2_Middle_Brick
  ; Determine left vs core vs right based on X position
  ; Sprite is ~16 pixels wide: left brick (0-5), core (6-9), right brick (10-15)
  ; Left brick: ballx < player1x + 6
  if ballx < player1x + 6 then goto __P2_Left_Brick
  ; Core (center): ballx >= player1x + 6 && ballx < player1x + 10
  if ballx < player1x + 10 then goto __P2_Core_Hit
  ; Right brick: ballx >= player1x + 10
