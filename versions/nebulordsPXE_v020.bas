  ;***************************************************************
  ;  NEBULORDS PXE - Version 020
  ;  Warlords-style Space Combat with Paddle Controls
  ;
  ;  Changes from v019:
  ;  - Applied consistent X offset (-1) to all Player 2 paddle positions
  ;  - Derived offset from user's perfect manual positioning of P1 and P2 South
  ;  - Player 2 circle now matches Player 1's perfect circle shape
  ;  - Accounts for player2 vs player3 sprite rendering differences
  ;
  ;  Player 1 positions (perfect circle from v019):
  ;  - All 16 positions manually tuned for perfect circular distribution
  ;
  ;  Player 2 positions (calculated):
  ;  - Applied offset (X=-1, Y=0) to match P1's perfect circle
  ;  - Based on empirical data: P1 South (4,28) vs P2 South (3,28)
  ;
  ;  Technical details:
