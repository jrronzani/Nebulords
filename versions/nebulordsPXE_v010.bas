  ;***************************************************************
  ;  NEBULORDS PXE - Version 010
  ;  Warlords-style Space Combat with Paddle Controls
  ;
  ;  Changes from v009:
  ;  - Added button-activated movement using CORRECT paddle buttons!
  ;  - Paddle 0 button = joy0right (NOT joy0fire!)
  ;  - Paddle 1 button = joy0left (NOT joy1fire!)
  ;  - joy0fire/joy1fire are JOYSTICK buttons and conflict with paddles
  ;
  ;  Controls:
