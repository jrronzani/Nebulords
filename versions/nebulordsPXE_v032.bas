  ;***************************************************************
  ;  NEBULORDS PXE - Version 032
  ;  Warlords-style Space Combat with Paddle Controls
  ;
  ;  Changes from v030:
  ;  - BRICK DESTRUCTION SYSTEM: Track and destroy bricks on hit
  ;  - Each player has 4 bricks: Top, Left, Right, Bottom (stored as bit flags)
  ;  - Brick hitboxes defined for each section of sprite
  ;  - Ball collision destroys bricks and bounces
  ;  - When brick destroyed, that side exposed for core hit
