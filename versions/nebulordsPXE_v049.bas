...
__P1_Brick_Hit
  ...
  ; Bottom brick: Ball bottom in Y offset 21-25 (visual bottom of sprite)
  if bally + 4 > player0y + 21 then goto __P1_Bottom_Brick
  ; Middle section (left/core/right): Ball bottom in Y offset 7-20 (core expanded +2 vertical)
  if bally + 4 > player0y + 7 then goto __P1_Middle_Brick
  ; Top brick: Ball bottom in Y offset 0-6 (visual top of sprite)
  goto __P1_Top_Brick
...
__P1_Middle_Brick
  ...
  ; Core expanded: +1 pixel on each side
  ; Left brick: ballx < player0x + 5
  if ballx < player0x + 5 then goto __P1_Left_Brick
  ; Core (center): ballx >= player0x + 5 && ballx < player0x + 11 (6 pixels wide)
  if ballx < player0x + 11 then goto __P1_Core_Hit
  ; Right brick: ballx >= player0x + 11
...
__P2_Brick_Hit
  ...
  ; Bottom brick: Ball bottom in Y offset 21-25 (visual bottom of sprite)
  if bally + 4 > player1y + 21 then goto __P2_Bottom_Brick
  ; Middle section (left/core/right): Ball bottom in Y offset 7-20 (core expanded +2 vertical)
  if bally + 4 > player1y + 7 then goto __P2_Middle_Brick
  ; Top brick: Ball bottom in Y offset 0-6 (visual top of sprite)
  goto __P2_Top_Brick
...
__P2_Middle_Brick
  ...
  ; Core expanded: +1 pixel on each side, +2 pixel shift for P2
  ; Left brick: ballx < player1x + 7
  if ballx < player1x + 7 then goto __P2_Left_Brick
  ; Core (center): ballx >= player1x + 7 && ballx < player1x + 13 (6 pixels wide, shifted +2)
  if ballx < player1x + 13 then goto __P2_Core_Hit
  ; Right brick: ballx >= player1x + 13
