  ;***************************************************************
  ;  NEBULORDS PXE - Version 040
  ;  Warlords-style Space Combat with Paddle Controls
  ;
  ;  Changes from v039:
  ;  - FIX: Deflections now maintain current ball speed (fast or slow)
  ;  - FIX: Increased paddle hitbox size (prevents ball passing through)
  ;  - TWEAK: Adjusted launch speeds for more consistency across directions
  ;
  ;  Changes from v038:
...
__Ball_Bounce_P1
  ...
  ; Otherwise BOUNCE - maintain current ball speed
  temp_dir = (temp_dir + 8) & 15
