  ;***************************************************************
  ;  NEBULORDS PXE - Version 098
  ;  Warlords-style Space Combat with Paddle Controls
  ;
  ;  Changes from v097:
  ;  - FIX: Score byte ordering now matches test_4player_score_v3.bas EXACTLY
  ;  - FIX: P1 now updates 2nd digit from left (not rightmost)
  ;  - CHANGE: Reversed score_byte variable assignments to match test file
  ;  - Display now correctly shows _0000_ format
  ;
  ;  Changes from v096:
