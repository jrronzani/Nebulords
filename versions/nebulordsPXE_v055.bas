...
__P1_Brick_Hit
  ...
  ; SIMPLE BRICK DETECTION:
  ; 1. Determine which hitbox area ball is in (top/left/right/bottom)
  ; 2. If brick exists: destroy it and bounce
  ; 3. If brick destroyed: check if ball overlaps core, if yes die, else pass through

  ; Y determines top/middle/bottom section
  if bally + 4 > player0y + 20 then goto __P1_Bottom_Area
  if bally + 4 > player0y + 6 then goto __P1_Middle_Area
  goto __P1_Top_Area

__P1_Top_Area
  ; Top brick - if exists, destroy and bounce
  if p1_bricks{0} then p1_bricks{0} = 0 : goto __P1_Brick_Bounce
  ; Top brick destroyed - check core
  if ballx + 2 >= player0x + 5 then if ballx <= player0x + 11 then goto __P1_Core_Hit
  return

__P1_Middle_Area
  ; X determines left or right side
  if ballx + 1 < player0x + 8 then goto __P1_Left_Area
  goto __P1_Right_Area

__P1_Left_Area
  ; Left brick - if exists, destroy and bounce
  if p1_bricks{2} then p1_bricks{2} = 0 : goto __P1_Brick_Bounce
  ; Left brick destroyed - check core
  if ballx + 2 >= player0x + 5 then if ballx <= player0x + 11 then goto __P1_Core_Hit
  return
...
__P1_Right_Area
  ...
  ; Right brick destroyed - check core
  if ballx + 2 >= player0x + 5 then if ballx <= player0x + 11 then goto __P1_Core_Hit
  return
...
__P1_Bottom_Area
  ...
  ; Bottom brick destroyed - check core
  if ballx + 2 >= player0x + 5 then if ballx <= player0x + 11 then goto __P1_Core_Hit
  return
...
__P2_Brick_Hit
  ...
  ; Y determines top/middle/bottom section
  if bally + 4 > player1y + 20 then goto __P2_Bottom_Area
  if bally + 4 > player1y + 6 then goto __P2_Middle_Area
  goto __P2_Top_Area
...
__P2_Middle_Area
  ; X determines left or right side (shifted +2 for P2)
  if ballx + 1 < player1x + 10 then goto __P2_Left_Area
