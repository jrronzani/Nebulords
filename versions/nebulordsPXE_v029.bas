  ;***************************************************************
  ;  NEBULORDS PXE - Version 029
  ;  Warlords-style Space Combat with Paddle Controls
  ;
  ;  Changes from v028:
  ;  - BALL/PADDLE COLLISION: Ball bounces off paddles directionally
  ;  - When ball hits paddle (player2/player3), bounces in paddle's facing direction
  ;  - Uses 16-direction lookup table for paddle deflection
  ;  - Ball maintains speed through paddle bounce
  ;
  ;  Physics System:
...
__BV_15
  ...
  ;***************************************************************
  ;  Ball Bounce off Paddles - Deflect based on paddle direction
