  ;***************************************************************
  ;  NEBULORDS PXE - Version 088
  ;  Warlords-style Space Combat with Paddle Controls
  ;
  ;  Changes from v087:
  ;  - ADD: Visual score blocks at bottom of screen
  ;  - Shift playfield up 8 scanlines to make room
  ;  - Add 2 black separator lines + 6 scanlines for score blocks
  ;  - Each player gets 4-pixel-wide blocks (P1/P2/P3/P4)
  ;  - Blocks show 0-3 wins visually (extend right)
  ;  - P1 at left, P2 at 1/4, P3 at 1/2, P4 at 3/4 screen
  ;
  ;  Changes from v079B:
  ;  - ADD: Win tracking (repurpose score display to show wins)
  ;  - ADD: P1/P2 wins displayed in score area (0-3)
  ;  - ADD: First to 3 wins ends the game
  ;  - Simpler than pfscore/pfpixel - just use existing score display
  ;
  ;  Changes from v077:
...
__P1_Core_Hit
  ...
  gosub __Award_P2_Point         ; Award win to Player 2 (score shows wins)
  if p2_score >= $03 then goto __Game_Over  ; First to 3 wins
...
__P2_Core_Hit
  ...
  gosub __Award_P1_Point         ; Award win to Player 1 (score shows wins)
  if p1_score >= $03 then goto __Game_Over  ; First to 3 wins
