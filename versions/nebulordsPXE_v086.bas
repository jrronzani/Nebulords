  ;***************************************************************
  ;  NEBULORDS PXE - Version 086
  ;  Warlords-style Space Combat with Paddle Controls
  ;
  ;  Changes from v079:
  ;  - OPTIMIZE: Remove redundant paddle sprite definitions
  ;  - Define player2/player3 sprites once instead of 64 times
  ;  - Keep all 32 position handlers but remove sprite redefinitions
  ;  - Should save ~576 lines (9 lines × 64 positions)
  ;
  ;  Changes from v077:
...
__Award_P2_Point
  ...
  ;#######################################################################
  ;***************************************************************
  ;  GLOBAL PADDLE SPRITE DEFINITIONS
  ;  Defined once and used for all 32 positions (P1 and P2)
  ;***************************************************************
  player2:
    %011110
    %111111
