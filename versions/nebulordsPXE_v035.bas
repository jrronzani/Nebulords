...
__BF1_0  ; South - paddle at (+4, +28), offset (+4, +2)
  ballx = player0x + 8 : bally = player0y + 30 : return
__BF1_1  ; SSW - paddle at (-1, +24), offset (+1, +2)
  ballx = player0x + 0 : bally = player0y + 26 : return
__BF1_2  ; SW - paddle at (-5, +21), offset (-2, +2)
  ballx = player0x - 7 : bally = player0y + 23 : return
__BF1_3  ; WSW - paddle at (-8, +15), offset (-2, 0)
  ballx = player0x - 10 : bally = player0y + 15 : return
__BF1_4  ; West - paddle at (-8, +8), offset (-2, -2)
  ballx = player0x - 10 : bally = player0y + 6 : return
__BF1_5  ; WNW - paddle at (-8, +1), offset (-2, -4)
  ballx = player0x - 10 : bally = player0y - 3 : return
__BF1_6  ; NW - paddle at (-5, -5), offset (-2, -6)
  ballx = player0x - 7 : bally = player0y - 11 : return
__BF1_7  ; NNW - paddle at (-2, -9), offset (+1, -6)
  ballx = player0x - 1 : bally = player0y - 15 : return
__BF1_8  ; North - paddle at (+4, -11), offset (+4, -6)
  ballx = player0x + 8 : bally = player0y - 17 : return
__BF1_9  ; NNE - paddle at (+8, -9), offset (+6, -6)
  ballx = player0x + 14 : bally = player0y - 15 : return
__BF1_10  ; NE - paddle at (+13, -5), offset (+8, -6)
  ballx = player0x + 21 : bally = player0y - 11 : return
__BF1_11  ; ENE - paddle at (+16, +1), offset (+9, -4)
  ballx = player0x + 25 : bally = player0y - 3 : return
__BF1_12  ; East - paddle at (+16, +8), offset (+9, -2)
  ballx = player0x + 25 : bally = player0y + 6 : return
__BF1_13  ; ESE - paddle at (+16, +15), offset (+9, 0)
  ballx = player0x + 25 : bally = player0y + 15 : return
__BF1_14  ; SE - paddle at (+13, +21), offset (+8, +2)
  ballx = player0x + 21 : bally = player0y + 23 : return
__BF1_15  ; SSE - paddle at (+9, +24), offset (+6, +2)
  ballx = player0x + 15 : bally = player0y + 26 : return
...
__BF2_0  ; South - paddle at (+4, +28), offset (+4, +2)
  ballx = player1x + 8 : bally = player1y + 30 : return
__BF2_1  ; SSW - paddle at (-1, +24), offset (+1, +2)
  ballx = player1x + 0 : bally = player1y + 26 : return
__BF2_2  ; SW - paddle at (-5, +21), offset (-2, +2)
  ballx = player1x - 7 : bally = player1y + 23 : return
__BF2_3  ; WSW - paddle at (-8, +15), offset (-2, 0)
  ballx = player1x - 10 : bally = player1y + 15 : return
__BF2_4  ; West - paddle at (-8, +8), offset (-2, -2)
  ballx = player1x - 10 : bally = player1y + 6 : return
__BF2_5  ; WNW - paddle at (-8, +1), offset (-2, -4)
  ballx = player1x - 10 : bally = player1y - 3 : return
__BF2_6  ; NW - paddle at (-5, -5), offset (-2, -6)
  ballx = player1x - 7 : bally = player1y - 11 : return
__BF2_7  ; NNW - paddle at (-2, -9), offset (+1, -6)
  ballx = player1x - 1 : bally = player1y - 15 : return
__BF2_8  ; North - paddle at (+4, -11), offset (+4, -6)
  ballx = player1x + 8 : bally = player1y - 17 : return
__BF2_9  ; NNE - paddle at (+8, -9), offset (+6, -6)
  ballx = player1x + 14 : bally = player1y - 15 : return
__BF2_10  ; NE - paddle at (+13, -5), offset (+8, -6)
  ballx = player1x + 21 : bally = player1y - 11 : return
__BF2_11  ; ENE - paddle at (+16, +1), offset (+9, -4)
  ballx = player1x + 25 : bally = player1y - 3 : return
__BF2_12  ; East - paddle at (+16, +8), offset (+9, -2)
  ballx = player1x + 25 : bally = player1y + 6 : return
__BF2_13  ; ESE - paddle at (+16, +15), offset (+9, 0)
  ballx = player1x + 25 : bally = player1y + 15 : return
__BF2_14  ; SE - paddle at (+13, +21), offset (+8, +2)
  ballx = player1x + 21 : bally = player1y + 23 : return
__BF2_15  ; SSE - paddle at (+9, +24), offset (+6, +2)
  ballx = player1x + 15 : bally = player1y + 26 : return
