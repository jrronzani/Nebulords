   ...
   ;  Version 31 - Fix collision detection with temp variables
   ;  Move collision checks AFTER joystick input (temps need to be set first)
   ;***************************************************************
   ...
   ; p1_xspeed now uses temp5 (freed variable c)
   ; p1_yspeed now uses temp6 (freed variable d)
   ...
   ; p2_xspeed now uses temp3 (freed variable j)
   ; p2_yspeed now uses temp4 (freed variable k)
...
__Main_Loop
   ...
   if joy0right then temp5 = PLAYER_SPEED
   if joy0left then temp5 = 0 - PLAYER_SPEED

   ; Handle X collision bounce (check AFTER setting temp5)
   if temp5 && collision(player0, playfield) then temp5 = 0 - temp5 : player0x = player0x + temp5

   ; Apply X movement
   player0x = player0x + temp5
   ...
   if joy0down then temp6 = PLAYER_SPEED
   if joy0up then temp6 = 0 - PLAYER_SPEED

   ; Handle Y collision bounce (check AFTER setting temp6)
   if temp6 && collision(player0, playfield) then temp6 = 0 - temp6 : player0y = player0y + temp6
...
__Skip_P1_Controls
   ...
   ; Check joystick for X movement
   if joy1right then temp3 = PLAYER_SPEED
   if joy1left then temp3 = 0 - PLAYER_SPEED

   ; Handle X collision bounce (check AFTER setting temp3)
   if temp3 && collision(player1, playfield) then temp3 = 0 - temp3 : player1x = player1x + temp3

   ; Apply X movement
   player1x = player1x + temp3
   ...
   ; Check joystick for Y movement
   if joy1down then temp4 = PLAYER_SPEED
   if joy1up then temp4 = 0 - PLAYER_SPEED

   ; Handle Y collision bounce (check AFTER setting temp4)
   if temp4 && collision(player1, playfield) then temp4 = 0 - temp4 : player1y = player1y + temp4
...
__Skip_Ball_Move
   ...
   if collision(player0,player1) then temp5 = 0 : temp6 = 0 : temp3 = 0 : temp4 = 0
