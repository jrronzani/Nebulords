   ...
   ;  Version 44 - Absolute bounce direction based on paddle facing
   ;  Based on v43 (wider side paddles)
   ;
   ;  Ball bounces in paddle's facing direction (not relative reversal)
   ;  Prevents inward bounces that cause penetration deaths
   ;
