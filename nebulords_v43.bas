   ...
   ;  Version 43 - Wider side paddles prevent horizontal approach deaths
   ;  Based on v42 (bounce speed boost)
   ;
   ;  Paddle width extended by 2 pixels on East/West directions
   ;  Prevents side-approach ball penetration
   ;
