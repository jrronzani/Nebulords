   ;***************************************************************
   ;  PFSCORE TEST V13 - Precise Collision Detection
   ;
   ...
   ;  - Collision bounds: Adjust wall boundaries for precise collision
   ;
   ...
   ;  - PRECISE collision detection with playfield walls
   ...
   ;***************************************************************
   ;  COLLISION BOUNDS - TWEAK FOR PRECISE WALL DETECTION!
   ;***************************************************************
   const wall_left = 16           ; Left wall X boundary
   const wall_right = 144         ; Right wall X boundary
   const wall_top = 18            ; Top wall Y boundary
   const wall_bottom = 69         ; Bottom wall Y boundary
...
__Check_Wall_Bounce
   ; Check left wall - use wall_left constant
   if player0x < wall_left then dir_x = 1 : player0x = wall_left : frame_counter_x = speed_x

   ; Check right wall - use wall_right constant
   if player0x > wall_right then dir_x = 255 : player0x = wall_right : frame_counter_x = speed_x

   ; Check top wall - use wall_top constant
   if player0y < wall_top then dir_y = 1 : player0y = wall_top : frame_counter_y = speed_y

   ; Check bottom wall - use wall_bottom constant
   if player0y > wall_bottom then dir_y = 255 : player0y = wall_bottom : frame_counter_y = speed_y
