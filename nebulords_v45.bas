   ...
   ;  Version 45 - Preserve launch timer when bouncing
   ;  Based on v44 (absolute bounce direction)
   ;
   ;  Bounce doesn't reset launch timer (keeps ball fast after launch bounce)
   ;
