   ...
   ;  Version 26 - Extended paddle and ball radius for safety
   ;  Paddle radius +1, ball radius +2 beyond paddle
   ;***************************************************************
...
__BP1_N
   ballx = player0x + 8 : bally = player0y - 15 : return
__BP1_NE
   ballx = player0x + 15 : bally = player0y - 13 : return
__BP1_E
   ballx = player0x + 17 : bally = player0y - 4 : return
__BP1_SE
   ballx = player0x + 15 : bally = player0y + 5 : return
__BP1_S
   ballx = player0x + 8 : bally = player0y + 7 : return
__BP1_SW
   ballx = player0x - 3 : bally = player0y + 5 : return
__BP1_W
   ballx = player0x - 5 : bally = player0y - 4 : return
__BP1_NW
   ballx = player0x - 3 : bally = player0y - 13 : return
...
__BP2_N
   ballx = player1x + 8 : bally = player1y - 15 : return
__BP2_NE
   ballx = player1x + 15 : bally = player1y - 13 : return
__BP2_E
   ballx = player1x + 17 : bally = player1y - 4 : return
__BP2_SE
   ballx = player1x + 15 : bally = player1y + 5 : return
__BP2_S
   ballx = player1x + 8 : bally = player1y + 7 : return
__BP2_SW
   ballx = player1x - 3 : bally = player1y + 5 : return
__BP2_W
   ballx = player1x - 5 : bally = player1y - 4 : return
__BP2_NW
   ballx = player1x - 3 : bally = player1y - 13 : return
...
__MP1_N
   missile0x = player0x + 8 : missile0y = player0y - 13 : goto __MP1_Done
__MP1_NE
...
__MP1_S
   missile0x = player0x + 8 : missile0y = player0y + 5 : goto __MP1_Done
__MP1_SW
...
__MP2_N
   missile1x = player1x + 8 : missile1y = player1y - 13 : goto __MP2_Done
__MP2_NE
...
__MP2_S
   missile1x = player1x + 8 : missile1y = player1y + 5 : goto __MP2_Done
__MP2_SW
